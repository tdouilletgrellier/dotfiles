...
│                                                     │
└─────────────────────────────────────────────────────┘${NC}"
echo -e "${BRed}$(date '+%D %T')${NC}"


function _exit()              # Function to run upon exit of shell.
{
    echo -e "${BRed}Leaving CRONOS ...${NC}"
}
trap _exit EXIT
...
alias ll='ls -FGlAhp --group-directories-first'                       # Preferred 'ls' implementation
...
alias weather="curl -s 'https://www.accuweather.com/en/fr/paris/623/current-weather/623' | sed -n '/Currently:/ s/.*: \(.*\): \([0-9]*\)\([CF]\).*/\2°\3, \1/p'"
...
alias sublime_text='/home/f66379/sublime_text_3/sublime_text'
