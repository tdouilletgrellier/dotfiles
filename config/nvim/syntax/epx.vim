...
" Europlexus titles
syn match epxTitle "\cTITLE.*$"
syn match epxTitle "\cTITRE.*$"

" Europlexus BEGIN/END DESCRIPTION 
syn region epxDescBlock start="\cBEGIN DESCRIPTION" end="END DESCRIPTION"
